...
!function(b) {
    ...
    t.prototype = {
        _init: function() {
            ...
            this._preload(),
            n || (s = b('<div class="vegas-content-scrollable">'),
            ...
            this.elmt.innerHTML = ""),
            o && this.support.transition && (e = b('<div class="vegas-timer"><div class="vegas-timer-progress">'),
            this.$timer = e,
            this.$elmt.prepend(e)),
            a && (i = b('<div class="vegas-overlay">'),
        ...
        _video: function(t) {
            ...
            return n[e] ? n[e] : (t instanceof Array || (t = [t]),
...
!function(jQuery, ytp) {
    jQuery.mbYTPlayer = {
        ...
        buildPlayer: function(options) {
            ...
            return this.each(function() {
                ...
                !YTPlayer.isBackground || !ytp.backgroundIsInited) {
                    ...
                    YTPlayer.isPlayer && YTPlayer.overlay.on("click", function() {
        ...
        playlist: function(a, b, c) {
            function d(h, i) {
                ...
                jQuery.getJSON(j, {
                    ...
                    e(h),
                    h.nextPageToken ? (i = h.nextPageToken,
                    d(plID, i, a)) : f.YTPlaylist(g.videos, b, c)
                })
            }
            function e(a) {
            ...
            var f = this
              , g = f.get(0);
            return "String" == typeof a && "" != jQuery.mbYTPlayer.apiKey ? (d(a),
            this) : (g.isList = !0,
            b && (a = jQuery.shuffle(a)),
            g.videoID || (g.videos = a,
            g.videoCounter = 1,
            g.videoLength = a.length,
            jQuery(g).data("property", a[0]),
            jQuery(g).YTPlayer()),
            "function" == typeof c && jQuery(g).one("YTPChanged", function() {
                c(g)
            }),
        ...
        toggleVolume: function() {
            var a = this.get(0);
            return a ? (a.player.isMuted() ? jQuery(a).YTPUnmute() : jQuery(a).YTPMute(),
            this) : this
        },
        mute: function() {
            var a = this.get(0);
        ...
        applyFilter: function(a, b) {
            var c = this
              , d = c.get(0);
            d.filters[a].value = b,
            d.filtersEnabled && c.YTPEnableFilters()
        },
        ...
        toggleFilter: function(a, b) {
            var c = this
              , d = c.get(0);
            return d.filters[a].value ? d.filters[a].value = 0 : d.filters[a].value = b,
        ...
        toggleFilters: function(a) {
            var b = this
              , c = b.get(0);
            return c.filtersEnabled ? (jQuery(c).trigger("YTPDisableFilters"),
        ...
        checkForState: function() {
            ...
            void (YTPlayer.getState = setInterval(function() {
                ...
                if (YTPlayer.isReady) {
                    ...
                    YTPlayer.player.playVideo()) : 1 == YTPlayer.state && (YTPlayer.hasFocus = !1,
                    $YTPlayer.YTPPause())),
                    ...
                    YTPlayer.player.getPlayerState() > 0 && (parseFloat(YTPlayer.player.getDuration() - .5) < YTPlayer.player.getCurrentTime() || stopAt > 0 && parseFloat(YTPlayer.player.getCurrentTime()) > stopAt)) {
                        ...
                        YTPlayer.isList) {
                            ...
                            void YTPlayer.wrapper.CSSAnimate({
                                ...
                                YTPlayer.isBackground ? YTPlayer.orig_background && jQuery(YTPlayer).css("background-image", YTPlayer.orig_background) : YTPlayer.opt.coverImage && YTPlayer.isPlayer && (YTPlayer.opt.coverImage = YTPlayer.opt.coverImage || YTPlayer.orig_background,
                                YTPlayer.opt.containment.css({
...
!function(e) {
    ...
    e.fn.cycle = function(i) {
        ...
        return 0 !== this.length || e.isReady ? this.each(function() {
            ...
            if (!l.data("cycle.opts")) {
                (l.data("cycle-log") === !1 || i && i.log === !1 || s && s.log === !1) && (r = e.noop),
                r("--c2 init--"),
                n = l.data();
                for (var a in n)
    ...
    e.fn.cycle.API = {
        ...
        add: function(t, i) {
            ...
            e(t).each(function(t) {
                var n, o = e(this);
                i ? s.container.prepend(o) : s.container.append(o),
                s.slideCount++,
                n = s.API.buildSlideOpts(o),
                i ? s.slides = e(o).add(s.slides) : s.slides = s.slides.add(o),
                s.API.initSlide(n, o, --s._maxZ),
                o.data("cycle.opts", n),
        ...
        calcTx: function(t, i) {
            var n, s = t;
            return s._tempFx ? n = e.fn.cycle.transitions[s._tempFx] : i && s.manualFx && (n = e.fn.cycle.transitions[s.manualFx]),
        ...
        prepareTx: function(e, t) {
            ...
            l.timeoutId = 0),
            void (l.busy || (0 !== l.timeoutId || e) && (n = l.slides[l.currSlide],
            s = l.slides[l.nextSlide],
            o = l.API.getSlideOpts(l.nextSlide),
            c = l.API.calcTx(o, e),
            l._tx = c,
            e && void 0 !== o.manualSpeed && (o.speed = o.manualSpeed),
            l.nextSlide != l.currSlide && (e || !l.paused && !l.hoverPaused && l.timeout) ? (l.API.trigger("cycle-before", [o, n, s, t]),
            ...
            l.API.calcNextSlide(),
            l.API.updateView()) : l.API.queueTransition(o))))
        },
        ...
        queueTransition: function(t, i) {
            ...
            void (n.nextSlide = n.currSlide)) : void 0 !== n.continueAuto && (n.continueAuto === !1 || e.isFunction(n.continueAuto) && n.continueAuto() === !1) ? (n.API.log("terminating automatic transitions"),
            n.timeout = 0,
            void (n.timeoutId && clearTimeout(n.timeoutId))) : void (s && (n._lastQueue = e.now(),
        ...
        buildSlideOpts: function(i) {
            ...
            for (var l in c)
                c.hasOwnProperty(l) && /^cycle[A-Z]+/.test(l) && (n = c[l],
                s = l.match(/^cycle(.*)/)[1].replace(/^[A-Z]/, t),
        ...
        updateView: function(e, t, i) {
            ...
            if (n._initialized) {
                ...
                !e && t !== !0 && (n.API.trigger("cycle-update-view-before", [n, s, o]),
                ...
                0 !== n.updateView && n.API.trigger("cycle-update-view", [n, s, o, e]),
...
function(e) {
    ...
    function t(t, n) {
        ...
        if ("container" == l)
            ...
            if (c = "calc" === l ? i(t, n) : l >= n.slides.length ? 0 : l,
            c == n._sentinelIndex)
                return;
            n._sentinelIndex = c,
    ...
    e(document).on("cycle-initialized", function(i, o) {
        ...
        "container" == r ? o.container.on("cycle-before", n) : "string" === a && /\d+\:\d+/.test(r) && (l = r.match(/(\d+)\:(\d+)/),
        l = l[1] / l[2],
        o._autoHeightRatio = l),
...
function(e) {
    ...
    e.fn.cycle = function(i) {
        ...
        return "number" == e.type(i) ? this.cycle("goto", i) : "string" == e.type(i) ? this.each(function() {
            ...
            s = o.API[n],
            e.isFunction(s) ? (l = e.makeArray(c),
            l.shift(),
            s.apply(o.API, l)) : void t.log("unknown command: ", n))
    ...
    e.extend(t.API, {
        ...
        jump: function(e, t) {
            ...
            if (!n.busy || n.manualTrump) {
                var s = parseInt(e, 10);
                if (isNaN(s) || 0 > s || s >= n.slides.length)
                    return void n.API.log("goto: invalid slide index: " + s);
                if (s == n.currSlide)
                    return void n.API.log("goto: skipping, already on slide", s);
                n.nextSlide = s,
            ...
            a && (t.css("visibility", "hidden").appendTo("body").each(function(t) {
                ...
                void u.each(function() {
                    this.complete ? c() : e(this).load(function() {
                        ...
                        0 === --r && (i.API.log("slide skipped; img not loaded:", this.src),
                        0 === --a && "wait" == i.loader && s.apply(i.API, [l, n]))
                    })
                })) : (--a,
                void l.push(d))
            }),
...
function(e) {
    ...
    e(document).on("cycle-update-view", function(t, i, n) {
        var s;
        i.pager && (s = i.API.getComponent("pager"),
        s.each(function() {
...
function(e) {
    ...
    e(document).on("cycle-update-view", function(e, t, i, n) {
        if (!t.allowWrap) {
            ...
            t.currSlide == r ? o.addClass(s).prop("disabled", !0) : o.removeClass(s).prop("disabled", !1),
            t.currSlide === l ? c.addClass(s).prop("disabled", !0) : c.removeClass(s).prop("disabled", !1)
        }
    }),
    e(document).on("cycle-destroyed", function(e, t) {
    ...
    e(document).on("cycle-pre-initialize", function(t, i) {
        if (i.progressive) {
            ...
            r && (o.prepareTx = function(e, t) {
                var s, o;
                return e || 0 === n.length ? void r.apply(i.API, [e, t]) : void (t && i.currSlide == i.slideCount - 1 ? (o = n[0],
                n = n.slice(1),
                ...
                i.API.add(o)) : t || 0 !== i.currSlide ? r.apply(i.API, [e, t]) : (s = n.length - 1,
                o = n[s],
                n = n.slice(0, s),
                i.container.one("cycle-slide-added", function(e, t) {
                    setTimeout(function() {
...
$(document).ready(function() {
    ...
    $("#overlay-skin p").click(function() {
        $("#overlay-skin p").removeClass("active"),
        $(this).addClass("active"),
        $(this).hasClass("overlay-skin-white") ? $("body").addClass("white") : $("body").removeClass("white")
    }),
    $("#bullet-navigation p").click(function() {
        $("#bullet-navigation p").removeClass("active"),
        $(this).addClass("active"),
        $(this).hasClass("bullet-navigation-on") ? $(".grcs_bullet_nav").show() : $(".grcs_bullet_nav").hide()
    }),
    $("#overlay-animation p").click(function() {
        $("#overlay-animation p").removeClass("active"),
        $(this).addClass("active"),
        $(this).hasClass("overlay-animation-fade") ? ($("#overlay").addClass("edit"),
        $("#overlay").addClass("fade-In"),
        $("#overlay").removeClass("slide-from-bottom"),
        setTimeout(function() {
            $("#overlay").removeClass("edit")
        }, 10)) : ($("#overlay").addClass("edit"),
    ...
    $("#overlay-content-animation p").click(function() {
        $("#overlay-content-animation p").removeClass("active"),
        $(this).addClass("active"),
        $(this).hasClass("overlay-content-animation-fade") ? ($("#overlay > .overlay").addClass("edit"),
        $("#overlay > .overlay").addClass("fade-In"),
        $("#overlay > .overlay").removeClass("slide-from-bottom"),
        setTimeout(function() {
            $("#overlay > .overlay").removeClass("edit")
        }, 10)) : ($("#overlay > .overlay").addClass("edit"),
        $("#overlay > .overlay").removeClass("fade-In"),
        $("#overlay > .overlay").addClass("slide-from-bottom"),
        setTimeout(function() {
            $("#overlay > .overlay").removeClass("edit")
        }, 10))
    }),
...
if (isMobile.any() && jQuery("body").addClass("is-mobile"),
$(document).ready(function() {
    "use strict";
    !function(e, o, a, s) {
        var t, n = $(e), r = $(e + ">" + o), i = 0, c = !1, l = $(".go-up"), d = $(".go-down"), u = $(a), m = $(s), v = r.length, f = 0;
        function b() {
            if (f == v || !0 === blockProcess)
                return !1;
            blockProcess = !0,
            n.addClass("movement-in-progress"),
            0 === f && (prevent_class_removal = !1,
            $(".hero .container-mid").addClass("block-overflow"),
            m.children().css("transition", "all 1000ms 500ms"),
            u.addClass("overlay-active"),
            u.removeClass("show"),
            u.find("div.controls").removeClass("show"),
            $("#cycle").cycle("pause"),
            setTimeout(function() {
                n.addClass("open")
            }, 200)),
            ...
            setTimeout(function() {
                ...
                setTimeout(function() {
                    ...
                    setTimeout(function() {
                        blockProcess = !1,
                        n.removeClass("movement-in-progress")
                    }, 800)
                }, 400)
            }, 1e3)
        }
        function p() {
            if (0 === f || !0 === blockProcess)
                return !1;
            blockProcess = !0,
            n.addClass("movement-in-progress"),
            0 == c ? f -= 1 : (f = i,
            ...
            0 === f && (l.removeClass("active"),
            setTimeout(function() {
                prevent_class_removal = !0,
                m.children().css("transition", "all 800ms 200ms"),
                u.removeClass("overlay-active"),
                u.addClass("show"),
                "youtube" === option_hero_background_mode && setTimeout(function() {
        ...
        function g() {
            "on" !== option_overlay_bullet_navigation || $(".hero").hasClass("error-404") || ($(".grcs_bullet_nav .nav_dots").removeClass("active"),
            $(".grcs_bullet_nav .nav_dots").eq(f).addClass("active"))
        }
        switch (isMobile.any() && "on" == option_overlay_merge_sections_on_mobile && (jQuery("body").addClass("merge-true"),
        v = 1,
        $(".social_icons li .go-down").parent().remove()),
        "on" !== option_overlay_bullet_navigation || $(".hero").hasClass("error-404") || function() {
            $("body").append('<div class="grcs_bullet_nav"></div>');
            g(),
            $(".grcs_bullet_nav .nav_dots").click(function() {
                (i = $(".grcs_bullet_nav .nav_dots").index(this)) != f && (i < f ? (c = !0,
                p()) : (c = !0,
                b()))
            })
        }(),
        ...
        "white" == option_overlay_skin && $("body").addClass("white"),
        option_overlay_animation) {
        case "fade":
            n.addClass("fade-In");
            break;
        case "slide":
    ...
    }("#overlay", "section.overlay", "#hero .front-content", "#hero .front-content .container-mid"),
    $(".subscribe-form").submit(function() {
        ...
        return $.ajax({
            ...
            success: function(e) {
                ...
                0 === e.valid ? ($(".subscribe-form").addClass("error"),
                $(".subscribe-form input").attr("placeholder", e.message),
                $(".subscribe-form input").val(""),
                setTimeout(function() {
                    $(".subscribe-form").addClass("error-final")
                }, 1500)) : ($(".subscribe-form input,.subscribe-form button").val("").prop("disabled", !0),
                $(".subscribe-form input").attr("placeholder", e.message),
    ...
    $("#contact-form").submit(function(e) {
        ...
        $.ajax({
            ...
            success: function(e) {
                ...
                setTimeout(function() {
                    "" !== e.nameMessage && ($("#contact-form-name").addClass("active").attr("placeholder", e.nameMessage),
                    $("#contact-form").addClass("error")),
                    "" !== e.emailMessage && ($("#contact-form-email").addClass("active").val("").attr("placeholder", e.emailMessage),
                    $("#contact-form").addClass("error")),
                    "" !== e.messageMessage && ($("#contact-form-message").addClass("active").attr("placeholder", e.messageMessage),
                    $("#contact-form").addClass("error"))
                }, 50),
                "" === e.nameMessage && "" === e.emailMessage && "" === e.messageMessage && ($("#contact-form").removeClass("error").addClass("success"),
                $("#contact-form textarea, #contact-form input").attr("placeholder", ""),
                $("#contact-form textarea").attr("placeholder", e.succesMessage),
                $("#contact-form input, #contact-form button, #contact-form textarea").val("").prop("disabled", !0))
            }
        })
    })
}),
...
$(document).ready(function() {
    ...
    function e() {
        ...
        var t, e, o, i = $(".hero .level-1").width(), n = $(".hero .level-1").height(), a = 0, s = 0, r = window.innerWidth / 2, h = window.innerHeight / 2;
        function c() {
        ...
        function u(t) {
            ...
            a = t.touches[0].pageX - r,
            s = t.touches[0].pageY - h)
        }
        function d(t) {
        ...
        !function() {
            ...
            (t = new THREE.PerspectiveCamera(75,i / n,1,1e4)).position.z = option_hero_background_sphere_distance,
            e = new THREE.Scene,
            (o = new THREE.CanvasRenderer).setPixelRatio(window.devicePixelRatio),
            o.setSize(i, n),
            a.appendChild(o.domElement),
            o.setClearColor(option_hero_background_sphere_background_color);
            for (var r = 2 * Math.PI, h = new THREE.SpriteCanvasMaterial({
                ...
                (s = new THREE.Sprite(h)).position.x = 2 * Math.random() - 1,
                s.position.y = 2 * Math.random() - 1,
                s.position.z = 2 * Math.random() - 1,
                s.position.normalize(),
                s.position.multiplyScalar(10 * Math.random() + 450),
            ...
            for (var g = 0; g < 300; g++) {
                ...
                _.normalize(),
                _.multiplyScalar(450),
                p.vertices.push(_);
                var m = _.clone();
                m.multiplyScalar(.3 * Math.random() + 1),
                p.vertices.push(m);
        ...
        function i() {
            ...
            g && (t.position.x += .05 * (a - t.position.x),
            t.position.y += .05 * (200 - s - t.position.y),
            t.lookAt(e.position),
    ...
    function o() {
        $(".hero .background-content .bg-overlay").css("z-index", "2");
        var t, e, o, i, n, a, s = option_hero_background_waves_dotSpacing, r = option_hero_background_waves_dotAmountX, h = option_hero_background_waves_dotAmountY, c = $(".hero .level-1").width(), l = $(".hero .level-1").height(), u = 0, d = 0, g = 0, p = c / 2, _ = l / 2;
        function m() {
        ...
        function v(t) {
            t.touches.length > 1 && (t.preventDefault(),
            d = t.touches[0].pageX - p,
            g = t.touches[0].pageY - _)
        }
        function b(t) {
            1 === t.touches.length && (t.preventDefault(),
            d = t.touches[0].pageX - p,
        ...
        !function() {
            ...
            (e = new THREE.PerspectiveCamera(75,c / l,1,1e4)).position.z = option_hero_background_waves_distance,
            o = new THREE.Scene,
            n = new Array;
            for (var u = 2 * Math.PI, d = new THREE.SpriteCanvasMaterial({
                ...
                for (var _ = 0; _ < h; _++)
                    (a = n[g++] = new THREE.Sprite(d)).position.x = p * s - r * s / 2,
                    a.position.z = _ * s - h * s / 2,
                    o.add(a);
            (i = new THREE.CanvasRenderer).setPixelRatio(window.devicePixelRatio),
            i.setSize(c, l),
            t.appendChild(i.domElement),
            i.setClearColor(option_hero_background_waves_background_color),
        ...
        function t() {
            ...
            !function() {
                if (y) {
                    e.position.x += .05 * (d - e.position.x),
                    e.position.y += .05 * (-g - e.position.y),
                    e.lookAt(o.position);
                    for (var t = 0, s = 0; s < r; s++)
                        for (var c = 0; c < h; c++)
                            (a = n[t++]).position.y = 50 * Math.sin(.3 * (s + u)) + 50 * Math.sin(.5 * (c + u)),
                            a.scale.x = a.scale.y = 4 * (Math.sin(.3 * (s + u)) + 1) + 4 * (Math.sin(.5 * (c + u)) + 1);
                    i.render(o, e),
                    u += .1
                }
            }()
    ...
    function i() {
        ...
        var t, e, o, i, n, a, s, r = setInterval(function() {
            ...
            renderer: "canvas"
        }, u = Date.now(), d = FSS.Vector3.create(), g = FSS.Vector3.create(), p = document.getElementById("canvas"), _ = document.getElementById("canvas");
        function m() {
            var t, s;
            for (o.remove(i),
            e.clear(),
            n = new FSS.Plane(h.width * e.width,h.height * e.height,h.segments,h.slices),
            a = new FSS.Material(h.ambient,h.diffuse),
            i = new FSS.Mesh(n,a),
            o.add(i),
            t = n.vertices.length - 1; t >= 0; t--)
                (s = n.vertices[t]).anchor = FSS.Vector3.clone(s.position),
                s.step = FSS.Vector3.create(Math.randomInRange(.2, 1), Math.randomInRange(.2, 1), Math.randomInRange(.2, 1)),
                s.time = Math.randomInRange(0, Math.PIM2)
        }
        function f(t, o) {
            e.setSize(t, o),
            FSS.Vector3.set(d, e.halfWidth, e.halfHeight),
            m()
        }
        function v() {
            t = Date.now() - u,
            function() {
                ...
                FSS.Vector3.copy(c.bounds, d),
                FSS.Vector3.multiplyScalar(c.bounds, c.xyScalar),
                FSS.Vector3.setZ(g, c.zOffset),
                c.autopilot && (e = Math.sin(c.step[0] * t * c.speed),
                i = Math.cos(c.step[1] * t * c.speed),
                FSS.Vector3.set(g, c.bounds[0] * e, c.bounds[1] * i, c.zOffset));
                for (s = o.lights.length - 1; s >= 0; s--) {
                    r = o.lights[s],
                    FSS.Vector3.setZ(r.position, c.zOffset);
                    var _ = Math.clamp(FSS.Vector3.distanceSquared(r.position, g), c.minDistance, c.maxDistance)
                      , m = c.gravity * r.mass / _;
                    FSS.Vector3.subtractVectors(r.force, g, r.position),
                    FSS.Vector3.normalise(r.force),
                    FSS.Vector3.multiplyScalar(r.force, m),
                    FSS.Vector3.set(r.acceleration),
                    FSS.Vector3.add(r.acceleration, r.force),
                    FSS.Vector3.add(r.velocity, r.acceleration),
                    FSS.Vector3.multiplyScalar(r.velocity, c.dampening),
                    FSS.Vector3.limit(r.velocity, c.minLimit, c.maxLimit),
                    FSS.Vector3.add(r.position, r.velocity)
                }
                for (l = n.vertices.length - 1; l >= 0; l--)
                    u = n.vertices[l],
                    e = Math.sin(u.time + u.step[0] * t * h.speed),
                    i = Math.cos(u.time + u.step[1] * t * h.speed),
                    a = Math.sin(u.time + u.step[2] * t * h.speed),
                    FSS.Vector3.set(u.position, h.xRange * n.segmentWidth * e, h.yRange * n.sliceHeight * i, h.zRange * p * a - p),
        ...
        function b() {
            ...
            if (e.render(o),
            c.draw)
                for (t = o.lights.length - 1; t >= 0; t--)
                    i = (a = o.lights[t]).position[0],
                    n = a.position[1],
                    e.context.lineWidth = .5,
                    e.context.beginPath(),
                    e.context.arc(i, n, 10, 0, Math.PIM2),
                    e.context.strokeStyle = a.ambientHex,
                    e.context.stroke(),
                    e.context.beginPath(),
                    e.context.arc(i, n, 4, 0, Math.PIM2),
                    e.context.fillStyle = a.diffuseHex,
                    e.context.fill()
        }
        function y(t) {
            f(p.offsetWidth, p.offsetHeight),
            b()
        }
        if (s = new FSS.CanvasRenderer,
        l.renderer,
        e && _.removeChild(e.element),
        (e = s).setSize(p.offsetWidth, p.offsetHeight),
        _.appendChild(e.element),
        o = new FSS.Scene,
        m(),
        function() {
            var t, i;
            ...
            for (e.clear(),
            t = 0; t < c.count; t++)
                (i = new FSS.Light(c.ambient,c.diffuse)).ambientHex = i.ambient.format(),
                i.diffuseHex = i.diffuse.format(),
                o.add(i),
                i.mass = Math.randomInRange(.5, 1),
                i.velocity = FSS.Vector3.create(),
                i.acceleration = FSS.Vector3.create(),
                i.force = FSS.Vector3.create(),
                i.ring = document.createElementNS(FSS.SVGNS, "circle"),
                i.ring.setAttributeNS(null, "stroke", i.ambientHex),
                i.ring.setAttributeNS(null, "stroke-width", "0.5"),
                i.ring.setAttributeNS(null, "fill", "none"),
                i.ring.setAttributeNS(null, "r", "10"),
                i.core = document.createElementNS(FSS.SVGNS, "circle"),
                i.core.setAttributeNS(null, "fill", i.diffuseHex),
                i.core.setAttributeNS(null, "r", "4")
        }(),
        ...
        canvas.getContext) {
            ...
            setInterval(function() {
                for (var t = 1; t <= 1e3; t++)
                    x.beginPath(),
                    w ? (x.moveTo(0, randomize(canvas.height + 10)),
                    w = !1) : (x.moveTo(randomize(canvas.width + 10), 0),
                    w = !0),
                    x.lineTo(randomize(canvas.width + 50), randomize(canvas.height + 50)),
                    x.lineTo(randomize(canvas.width + 50), randomize(canvas.height + 50)),
                    x.fillStyle = getRndColor(),
                    x.fill()
            }, 5e3)
        }
    }
        ...
        "on" === option_hero_gravity_effect && function() {
            function t(t, e) {
                    ...
                    line: function() {
                        ...
                        for (o = 0; o < n; o++)
                            for (i = 0; i < n; i++)
                                t = h.stars[o],
                                e = h.stars[i],
                                t.x - e.x < h.distance && t.y - e.y < h.distance && t.x - e.x > -h.distance && t.y - e.y > -h.distance && t.x - h.position.x < h.radius && t.y - h.position.y < h.radius && t.x - h.position.x > -h.radius && t.y - h.position.y > -h.radius && (s.beginPath(),
                                s.moveTo(t.x, t.y),
                                s.lineTo(e.x, e.y),
                                s.stroke(),
                                s.closePath())
                ...
                this.createStars = function() {
                    var e, o, i = h.length;
                    for (s.clearRect(0, 0, t.width, t.height),
                    o = 0; o < i; o++)
                        h.stars.push(new c),
                        (e = h.stars[o]).create();
                    e.line(),
                ...
                this.setCanvas = function() {
                    t.width = h.width,
                    t.height = h.height,
                    s.fillStyle = h.star.color,
                    s.strokeStyle = h.line.color,
                    s.lineWidth = h.line.width,
                    e && e.hasOwnProperty("position") || (h.position = {
                        x: .5 * t.width,
                        y: .5 * t.height
                    })
                }
                ...
                this.bind = function() {
                    $(window).on("mousemove", function(t) {
                        h.position.x = t.pageX - a.offset().left,
                        h.position.y = t.pageY - a.offset().top
                    })
                }
                ,
                this.init = function() {
    ...
    case "youtube":
        jQuery.browser.mobile ? t() : function() {
            "on" === option_hero_background_youtube_controls && $(".hero .front-content").append('<div class="controls"><i class="volume-button fa fa-volume-up"></i><i class="pause-button ti-control-pause"></i></div>'),
            "on" === option_hero_background_youtube_mute && (option_hero_background_youtube_mute = !0,
            $(".volume-button").removeClass("fa-volume-up").addClass("fa-volume-off")),
            "off" === option_hero_background_youtube_mute && (option_hero_background_youtube_mute = !1),
            "off" === option_hero_background_youtube_loop ? option_hero_background_youtube_loop = !1 : option_hero_background_youtube_loop = !0,
            ...
            $(".volume-button").click(function() {
                $("#bg-youtube").hasClass("isMuted") ? ($("#bg-youtube").YTPUnmute(),
                $(".volume-button").removeClass("fa-volume-off").addClass("fa-volume-up")) : ($("#bg-youtube").YTPMute(),
                $(".volume-button").removeClass("fa-volume-up").addClass("fa-volume-off"))
            });
            var t = !0;
            ...
            $(".pause-button").click(function() {
                1 == t ? ($("#bg-youtube").YTPPause(),
                $(".pause-button").removeClass("ti-control-pause").addClass("ti-control-play")) : ($("#bg-youtube").YTPPlay(),
    ...
    case "color":
        ...
        break;
    case "gradient":
        r = option_hero_background_gradient_colorArray,
        h = 0,
        c = $(".bg-color"),
        l = [0, 1, 2, 3],
        u = option_hero_background_gradient_stransitionSpeed / 1e4,
        setInterval(function() {
            var t = r[l[0]]
              , e = r[l[1]]
              , o = r[l[2]]
            ...
            l[0] = l[1],
            l[2] = l[3],
            l[1] = (l[1] + Math.floor(1 + Math.random() * (r.length - 1))) % r.length,
            l[3] = (l[3] + Math.floor(1 + Math.random() * (r.length - 1))) % r.length)
        }, 1),
        $(".hero .bg-color").css("opacity", "1"),
        $(".hero .bg-pattern").remove(),
        $(".hero .bg-overlay").remove(),
    ...
    case "mesh":
        !function() {
            ...
            function v() {
                requestAnimationFrame(v),
                l || (c.x = o / 2 + 90 * Math.cos(p / 40),
                c.y = i / 2 + 90 * Math.sin(p / 40)),
                ...
                function() {
                    ...
                    for (var t = 0; t < u; t++)
                        for (var n = 0; n < d; n++)
                            s = g[t * d + n],
                            r = t === u - 1 ? null : g[(t + 1) * d + n],
                            h = n === d - 1 ? null : g[t * d + n + 1],
                            r && (e.moveTo(s.x, s.y),
                            e.lineTo(r.x, r.y)),
                            h && (e.moveTo(s.x, s.y),
                            e.lineTo(h.x, h.y));
                    ...
                    a.addColorStop(1, "hsla(0, 0%, 0%, 0.93)"),
                    e.fillStyle = a,
                    e.fillRect(0, 0, o, i)
                }()
            }
            _.prototype.step = function() {
                this.x = this.xBase + this.dir * Math.sin((p + this.offset) / this.duration) * this.range,
                this.y = this.yBase + this.dir * Math.cos((p + this.offset) / this.duration) * this.range;
                var t, e, o, i, n = (e = c,
                o = (t = this).x - e.x,
                i = t.y - e.y,
                Math.atan2(i, o));
                this.x = this.x + 100 * Math.cos(n),
                this.y = this.y + 100 * Math.sin(n)
            }
            ,
    ...
    case "space":
        !function(t, e, o, i) {
            ...
            !function() {
                for (var t = 0, o = ["ms", "moz", "webkit", "o"], i = 0; i < o.length && !e.requestAnimationFrame; ++i)
                    e.requestAnimationFrame = e[o[i] + "RequestAnimationFrame"],
                    e.cancelAnimationFrame = e[o[i] + "CancelAnimationFrame"] || e[o[i] + "CancelRequestAnimationFrame"];
            ...
            r.prototype = {
                ...
                resizer: function() {
                    ...
                    for (var a = 0; a < this.n; a++)
                        this.star[a][0] = t[a][0] * i,
                        this.star[a][1] = t[a][1] * n,
                    ...
                    s.context.fillStyle = s.settings.bgColor,
                    this.context.strokeStyle = this.settings.starColor
                },
                init: function() {
                    this.settings = t.extend({}, this.defaults, this.options);
                    var i = o.location.href;
                    this.n = parseInt(-1 != i.indexOf("n=") ? i.substring(i.indexOf("n=") + 2, -1 != i.substring(i.indexOf("n=") + 2, i.length).indexOf("&") ? i.indexOf("n=") + 2 + i.substring(i.indexOf("n=") + 2, i.length).indexOf("&") : i.length) : this.settings.quantity),
                    this.flag = !0,
                    this.test = !0,
                    this.w = 0,
                    this.h = 0,
                    ...
                    s.initH = s.h,
                    s.portrait = s.w < s.h,
                    s.wrapper = t("<canvas />").addClass(s.settings.divclass),
                    s.wrapper.appendTo(s.el),
                    s.starz = t("canvas", s.el),
                    s.starz[0].getContext && (s.context = s.starz[0].getContext("2d"),
                    c = !0),
                    s.context.canvas.width = s.w,
                    s.context.canvas.height = s.h,
                    function() {
                        if (c) {
                            s.x = Math.round(s.w / 2),
                            s.y = Math.round(s.h / 2),
                            s.z = (s.w + s.h) / 2,
                            s.star_color_ratio = 1 / s.z,
                            s.cursor_x = s.x,
                            s.cursor_y = s.y;
                            for (var t = 0; t < s.n; t++)
                                s.star[t] = new Array(5),
                                s.star[t][0] = Math.random() * s.w * 2 - 2 * s.x,
                                s.star[t][1] = Math.random() * s.h * 2 - 2 * s.y,
                                s.star[t][2] = Math.round(Math.random() * s.z),
                                s.star[t][3] = 0,
                                s.star[t][4] = 0;
                            s.context.fillStyle = s.settings.bgColor,
                            s.context.strokeStyle = s.settings.starColor
                        }
                    }(),
                    h = !0
                },
                ...
                move: function() {
                    ...
                    this.orientationSupport && !this.desktop ? e.addEventListener("deviceorientation", function(t) {
                        if (null !== t.beta && null !== t.gamma) {
                            var e = t.gamma
                              , o = t.beta;
                            s.portrait || (e = -1 * t.beta,
                            o = t.gamma),
                            s.cursor_x = s.w / 2 + 5 * e,
                            s.cursor_y = s.h / 2 + 5 * o
                        }
                    }, !1) : e.addEventListener("mousemove", function(e) {
                        s.cursor_x = e.pageX || e.clientX + t.scrollLeft - t.clientLeft,
                        s.cursor_y = e.pageY || e.clientY + t.scrollTop - t.clientTop
                    }, !1)
                },
                stop: function() {
    ...
    case "abstract":
        ...
        break;
    case "glitch":
        s = "background-image: url('" + option_hero_background_glitch_image + "')",
        $(".hero .level-2 .bg-image").append('<div class="glitch-img" style="' + s + '"></div>'),
        $(".glitch-img").mgGlitch({
            destroy: !1,
            glitch: !0,
            scale: !0,
    ...
    var g = 800
      , p = 6e3;
    "slider" === option_hero_background_mode && (g = option_hero_background_slider_transitionDuration,
    p = option_hero_background_slider_delay),
    "kenburns" === option_hero_background_mode && (g = option_hero_background_kenburns_transitionDuration,
    p = option_hero_background_kenburns_delay),
    $("#cycle").cycle({
        fx: "scrollVert",
        timeout: p,
        delay: 0,
